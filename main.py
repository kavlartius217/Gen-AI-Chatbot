...
if 'agent_executor' not in st.session_state:
    ...
    def initialize_agent():
        try:
            llm = ChatOpenAI(api_key="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")
            embeddings = OpenAIEmbeddings(api_key="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")
